...
<p align="center">
  <a href="https://github.com/kabirsingh2004/github-readme-streak-stats">
    <img src="https://github-readme-streak-stats.herokuapp.com/?user=kabirsingh2004#version3"/>
  </a>
</p>
...
<table>
  ...
  <tbody>
    <script>
      fetch("https://api.github.com/users/kabirsingh2004/repos?per_page=100")
        ...
        .then(data => {
          ...
          for (let i = 0; i < 5; i++) {
            const repo = sortedData[i];
            document.write(`
              <tr>
                <td><a href="${repo.html_url}"><b>${repo.name}</b></a></td>
                <td><img alt="Stars" src="https://img.shields.io/github/stars/${repo.full_name}?style=flat-square&labelColor=343b41"/></td>
                <td><img alt="Forks" src="https://img.shields.io/github/forks/${repo.full_name}?style=flat-square&labelColor=343b41"/></td>
              </tr>
            `);
          }
        });
